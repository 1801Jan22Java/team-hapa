...
public class Driver {
	...
	public static void main(String[] args) {
		...
		// SAVES ALL DISTANCES TO CSV FILE
		//allRoutes();
	...
	static void feedbackInit() {
		...
		EndUser eu1 = eud.getEndUserByEmail("john@doe.com");
		Feedback fe1 = new Feedback(eu1, "This is my messsage");
	...
	static void reservationInit() {
		...
		Flight f1 = fd.getFlightById(7);
		EndUser eu1 = eud.getEndUserByEmail("john@doe.com");
		CommonLookup clstatus = cld.getCommonLookupByName("RESERVATION_STATUS", "Reserved");
		CommonLookup cltype = cld.getCommonLookupByName("RESERVATION_TYPE", "Economy");
	...
	static void flightInit() {
		...
		arrivalState = sd.getStateByName("Pennsylvania");
		arrivalCountry = cod.getCountryByName("United States");
		arrivalCity = cd.getCityByName("Philadelphia", arrivalState, arrivalCountry);
	...
	static void commonlookupInit() {
		...
		CommonLookup cl2 = new CommonLookup("FLIGHT_TYPE", "Departure");
		cl2.setId(cld.addCommonLookup(cl2));
		
		CommonLookup cl3 = new CommonLookup("END_USER_TYPE", "Employee");
		cl3.setId(cld.addCommonLookup(cl3));
		
		CommonLookup cl4 = new CommonLookup("END_USER_TYPE", "Passenger");
		cl4.setId(cld.addCommonLookup(cl4));
		
		CommonLookup cl5 = new CommonLookup("RESERVATION_TYPE", "Economy");
		cl5.setId(cld.addCommonLookup(cl5));
		
		CommonLookup cl6 = new CommonLookup("RESERVATION_TYPE", "First Class");
		cl6.setId(cld.addCommonLookup(cl6));
		
		CommonLookup cl7 = new CommonLookup("RESERVATION_STATUS", "Reserved");
		cl7.setId(cld.addCommonLookup(cl7));
		
		CommonLookup cl8 = new CommonLookup("RESERVATION_STATUS", "Cancelled");
	...
	static void routeInit() {
		...
		departureState = sd.getStateByName("Arizona");
		departureCountry = cod.getCountryByName("United States");
		departureCity = cd.getCityByName("Phoenix", departureState, departureCountry);
		...
		arrivalState = sd.getStateByName("New York");
		arrivalCountry = cod.getCountryByName("United States");
		arrivalCity = cd.getCityByName("New York City", arrivalState, arrivalCountry);
